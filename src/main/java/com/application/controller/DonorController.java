...
public class DonorController
{
	...
	@GetMapping("/acceptstatus/{request_id}")
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<List<String>> updateStatus(@PathVariable("request_id") int request_id) throws Exception
	{
		donorService.updateStatus(request_id);
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<List<String>> rejectStatus(@PathVariable("email") String email) throws Exception
	{
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<List<Requesting>> getRequestHistoryByEmail(@PathVariable("email") String email) throws Exception
	{
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<List<Integer>> getTotalRequests(@PathVariable("email") String email) throws Exception
	{
		List<Requesting> history = donorService.getRequestHistoryByEmail(email);
		List<Integer> al=new ArrayList<>();
		al.add(history.size());
...
//	{
//		List<Donor> donors = donorService.getAllDonors(email);
//		List<Integer> al = new ArrayList<>();
//		int count = 0;
//		for(Donor val:donors)
//		{
//			if(val.getName().equalsIgnoreCase("sapan"))
//				count++;
//		}
//		al.add(count);
//		return new ResponseEntity<List<Integer>>(al, HttpStatus.OK);
